...
const BooleanDisplay = ({
  ...
  <div className="flex items-center justify-between rounded-[10px] border border-[#dce4e8] bg-white px-5 h-14">
    <span className="text-[16px] font-medium text-[#acb5bb]">{label}</span>
    <div
...
const InfoField = ({ label, value }: { label: string; value: string }) => {
  return (
    <div className="flex flex-col">
      ...
      <div className="z-1 flex h-14 items-center rounded-[10px] border border-[#dce4e8] bg-white px-5 text-[16px] font-medium leading-6 text-accent-foreground">
        {value}
      </div>
    </div>
  );
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-5 xl:grid-cols-2">
              ...
              <div className="flex flex-col">
                ...
                <div className="z-1 flex h-14 items-center rounded-[10px] border border-[#dce4e8] bg-white px-5">
                  <span
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-5 xl:grid-cols-2">
              ...
              <div className="flex flex-col">
                ...
                <div className="z-1 min-h-24 rounded-[10px] border border-[#dce4e8] bg-white px-5 py-4 text-[16px] font-medium leading-6 text-accent-foreground">
                  {formData.allergies}
                </div>
              </div>
              <div className="flex flex-col">
