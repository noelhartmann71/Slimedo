...
export default function ForgotPasswordPage() {
  ...
  const mutation = useMutation({
    mutationFn: async (email: string) => {
      const response = await axiosPublic.post("/forgot-password", { email });
    ...
    onSuccess: (data, variables) => {
      ...
      toast.success(
        data.message ||
          "Bestätigungscode erfolgreich gesendet! Bitte überprüfen Sie Ihre E-Mail.",
      );
      navigate("/auth/verify", { state: { email: variables } });
    },
          ...
          <div>
            ...
            <div className="space-y-4">
              <h1 className="text-[32px] font-medium leading-tight">
                Ärztlich überprüfte Online-Rezepte
              </h1>
              <p className="text-base leading-relaxed opacity-90">
                Slimedo hilft Patienten und Ärzten, nahtlos miteinander in
                Kontakt zu treten. Buchen Sie Sprechstunden, verfolgen Sie
                Aufzeichnungen und verbessern Sie Ihre Gesundheitsreise.
              </p>
            </div>
          </div>
          ...
          <div className="relative mt-auto pt-10 w-full group">
            <div className="relative inline-block">
              ...
              <div className="absolute left-[82%] top-8 z-20">
                <div className="bg-[#F4F1E7] text-black text-[16px] font-semibold px-4 py-2.5 rounded-tl-[95px] rounded-tr-[100px] rounded-br-[100px] rounded-bl-0 shadow-[0_8px_15px_-3px_rgba(238,66,215,0.3)] whitespace-nowrap">
                  Schön dich zu sehen!
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-130 bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-neutral-200">
              <div className="mb-6">
                ...
                <p className="text-neutral-500 text-base font-normal">
                  Geben Sie Ihre E-Mail-Adresse ein, um einen Bestätigungscode
                  zum Zurücksetzen Ihres Passworts zu erhalten.
                </p>
              </div>
                        ...
                        <FormControl>
                          <div className="relative mt-2">
                            ...
                            <Input
                              ...
                              className="pl-12 h-14 rounded-xl border-neutral-200 focus:border-sage focus-visible:ring-0 text-base placeholder:text-neutral-400"
                              {...field}
                            />
                          </div>
                        </FormControl>
