...
const cards = [
  {
    ...
    body: 'Kann SÃ¤ttigung fÃ¶rdern und HeiÃŸhunger reduzieren.',
    icon: (
      <svg width="52" height="52" viewBox="0 0 48 48" fill="none" color="#3D5C4A">
  ...
  },
  {
    ...
    body: 'UnterstÃ¼tzt die Regulation von Insulin und Glukagon.',
    icon: (
      <svg width="52" height="52" viewBox="0 0 48 48" fill="none" color="#3D5C4A">
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Die Therapie wirkt gezielt an vier Stellen in deinem KÃ¶rper.
        </p>
      </header>
